package com.ohgiraffers.associationmapping.section03.bidirectioin;
...
public class BidirectionService {
    ...
    public BidirectionService(BidirectionRepository biderectionRepository) {
        this.bidirectionRepository = biderectionRepository;
    }
