...
public class EntityManagerGeneratorTest {
    ...
    /* All -> before : 최초 한 번 테스트 코드가 실행되기 전 동작 */
    @BeforeAll
    ...
    /* 수업목표. Persistence Context 를 이해하기 위한 엔티티 메니저와 팩토리 */
    ...
    * */
    ...
    @Test
    @DisplayName("엔티티 매니저 팩터리 싱글톤 인스턴스 확인")
    ...
    *  */
    ...
    void testCreateManager() {
        ...
        System.out.println("manager의 해쉬코드 : " + manager.hashCode());
